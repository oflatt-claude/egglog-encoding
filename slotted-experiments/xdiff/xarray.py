...
def compile_array_rule(rule, atom_order=None):
    ...
    `slotted-tests/slotted-user-rules.egg`.
    ...
    `slotted-tests/generated/slotted-array-rules.egg` is committed, so they are kept as they were
    written.
    """
...
;;; compiled into the encoding by the recipe in `slotted-tests/slotted-user-rules.egg`.
...
def main():
    ...
    if args and args[0] == "egg":
        dest = ROOT / "slotted-tests" / "generated" / "slotted-array-rules.egg"
