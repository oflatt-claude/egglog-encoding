...
The rules are `slotted/languages/sdql-rules.egg`, written in the slotted language and read from
there rather than restated here; the recipe that compiles them is
`slotted/slotted-encoder.py`, which `slotted/ENCODING.md`
...
`slotted/ENCODING.md` is the same shape.
...
;;;
;;; The rules themselves are `slotted/languages/sdql-rules.egg`, written in the slotted language;
