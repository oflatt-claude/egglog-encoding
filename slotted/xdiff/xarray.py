...
#: the array language's machinery, compiled rather than read from `target/`
MACHINERY = machinery("array")
...
;;; compiled into the encoding by the recipe in `slotted/ENCODING.md`.
