...
recipe: `slotted/encoding/user-rules.egg` states it, section by section, and
...
`slotted/encoding/user-rules.egg`, asserted by
...
def compile_rule(
    ...
    The recipe `slotted/encoding/user-rules.egg` states. Atoms are taken in the order
